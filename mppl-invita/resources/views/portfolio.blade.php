...
<html lang="en">
  ...
  <body>
    ...
    <section class="jumbotron text-center text-white d-flex flex-column" style="padding-top: 100px">
      ...
      <!-- <div class="row-svg-jb row bg-dark" style="">
    ...
    <div class="container">
      <div class="row justify-content-evenly">
        <div class="col-xl-5 col-lg-6 ps-lg-5 col-md-9 col-sm-12 d-sm-block d-none pb-5">
          <div class="row row-portfolio" style="background-color: #f9f9f9">
            <div class="col-3 img-port bg-success p-0" style="">
              <img class="" src="img/putri-dean.png" alt="" />
            </div>
            <div class="col-9">
              <div class="row row-text-port mt-4" style="">
                ...
                <div class="col-10">
                  <h2 style="font-size: 2.5rem; color: #82b493">Putri & Dean</h2>
                </div>
              </div>
        ...
        <div class="col-xl-5 col-lg-6 ps-lg-5 col-md-9 col-sm-12 d-sm-block d-none pb-5">
          <div class="row row-portfolio" style="background-color: #f9f9f9">
            <div class="col-3 bg-success p-0" style="">
              <img class="" src="img/amalia-hilman.png" alt="" />
            </div>
            <div class="col-9">
              <div class="row row-text-port mt-4" style="">
                <div class="col-2 text-center">
                ...
                <div class="col-10">
                  <h2 style="font-size: 2.5rem; color: #82b493">Amalia & Hilman</h2>
                </div>
              </div>
              <div class="row mt-4 row-text-port" style="">
                <div class="col-2 text-center">
