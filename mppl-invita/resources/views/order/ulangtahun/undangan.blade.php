              ...
              @else
                ...
                @else
                  <div class="row-12 d-flex flex-column justify-content-center">
                    <a href="/ulangtahun/{{ $undangan[0]->slug }}" class="btn btn-primary m-2 px-4 shadow border-0" style="color: white; background:#0199ff;font-size: 16px;">Lihat Undangan</a>
                    <p class="fs-4 mt-3">Tautan Undangan: <a href="#">inivita.id/ulangtahun/{{ $undangan[0]->slug }}</a></p>
                  </div>
                @endif
              @endforeach
              @endif
            ...
            <div class="row gap-4">
                <div class="card justify-content-center" style="width: 18rem;">
                  ...
                  <div class="card d-flex justify-content-center" style="width: 18rem;">
                    ...
                    <div class="card-body">
                      <a href="/order/undangan/ulangtahun/{{ $undangan[0]->id }}/bukutamu" class="btn btn-primary shadow border-0" style="font-size: 14px; background:#0199ff;">Laporan Buku Tamu</a>
                    </div>
                  </div>
            </div>
        </div>
