...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Detail Undangan Ulang Tahun</h1>
</div>

<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="/">Dashboard</a></li>
    <li class="breadcrumb-item active"><a href="/ulang-tahun">Tabel</a></li>
...
<table class="table table-striped table-sm">
  ...
  <tbody>
      ...
      <tr>
        <td>Nama yang Berulang Tahun</td>
        <td>{{ $data[0]->honorific_ulangtahun }}. {{ $data[0]->nama_ulangtahun }}</td>
      </tr>
      <tr>
        <td>Tanggal Lahir</td>
        <td>{{ $data[0]->tanggal_lahir_ulangtahun }}</td>
      </tr>
      <tr>
        <td>Deskripsi</td>
        <td>{{ $data[0]->deskripsi_ulangtahun }}</td>
      </tr>
  </tbody>
</table>
